...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="?r=admin/design"><i class="icon-font">&#xe008;</i>作品管理</a></li>
                         <li><a href="?r=novel/novel_list"><i class="icon-font">&#xe008;</i>小说列表</a></li>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎使用『三组』小说程序，建博的首选工具。</span></div>
        </div>
